...
**Note**: In the actual implementation, the pre-processing is performed at the beginning of the template extraction step for better efficiency: fewer logs to be matched by the pre-processing regexes. 
